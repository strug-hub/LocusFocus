...
LocusFocus may be cloned from the `GitHub repository <https://github.com/strug-hub/LocusFocus>`_
...
`initdb_GTExV7.py <https://github.com/strug-hub/LocusFocus/blob/master/misc/initdb_GTExV7.py>`_
and `initdb_GTExV8.py <https://github.com/strug-hub/LocusFocus/blob/master/misc/initdb_GTExV7.py>`_ scripts.
...
All required programs and packages are listed in a `yml file <https://github.com/strug-hub/LocusFocus/blob/master/environment.yml>`_ and a
`conda spec file <https://github.com/strug-hub/LocusFocus/blob/master/spec-file.txt>`_ are also available for direct explicit
