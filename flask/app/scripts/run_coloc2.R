...
p <- add_argument(p, "gwas_filename", help = paste0(
...
p <- add_argument(p, "eqtl_filename", help = paste0(
...
# 82265b58-b4cb-47fe-922e-b08a7b9c994e
# gwas_filename <- "static/session_data/coloc2gwas_df-82265b58-b4cb-47fe-922e-b08a7b9c994e.txt"
# eqtl_filename <- "static/session_data/coloc2eqtl_df-82265b58-b4cb-47fe-922e-b08a7b9c994e.txt"
