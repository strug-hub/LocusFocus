...
From https://www.gtexportal.org/home/downloads/adult-gtex/qtl
...
conn = f"mongodb://{mongo_user}:{mongo_pass}@mongo:27017/{mongo_db}?authSource=admin"
...
#tissues = []
files_list = [f"{t}.v7.signif_variant_gene_pairs.txt.gz" for t in tissues]
...
print(
    "Reading variant lookup file GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.lookup_table.txt.gz"
)
