...
var myjumbotron = d3
  .select("#myjumbotron")
  .append("div")
  .classed("col-md-12 jumbotron text-center", true);
var navbar = d3
  .select("#navigation-bar")
  .append("div")
  .classed("col-md-12 borderit clearfix", true);

myjumbotron.append("h1").append("a").attr("href", "/").text("LocusFocus");
myjumbotron
  .append("p")
  .append("h4")
  .text("Colocalization Testing Across Datasets");
...
addLink("/setbasedtest", "First Stage Test Only");
...
var modalHeader = modalContent.append("div").classed("modal-header", true);
modalHeader
  .append("h4")
...
modalHeader
  ...
  .html("&times;");
var modalBody = modalContent.append("div").classed("modal-body", true);
modalBody.append("p").text("Authors:");
modalBody
  .append("p")
  .text(
    "Naim Panjwani, Fan Wang, Scott Mastromatteo, Allen Bao, Cheng Wang, Gengming He, Jiafen Gong, Johanna M. Rommens, Lei Sun, Lisa J. Strug"
  );
var modalFooter = modalContent.append("div").classed("modal-footer", true);
modalFooter
  .append("p")
  .append("a")
